<%@ Page Title="" Language="C#" MasterPageFile="~/usermaster.Master" AutoEventWireup="true" CodeBehind="subjectexam.aspx.cs" Inherits="Project_OnlineQuiz.subjectexam" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincontentplaceholder" runat="server">
    ...
    <hr />
    <div class="row">
        <asp:Repeater ID="gridview_sujectexam" runat="server" OnItemCommand="gridview_sujectexam_ItemCommand">
            <ItemTemplate>
